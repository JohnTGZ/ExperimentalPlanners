#ifndef _THETASTARBASIC2_H
#define _THETASTARBASIC2_H
...
namespace global_planner
{
    ...
    class ThetaStarBasic2 : public nav_core::BaseGlobalPlanner
    {
    public:
        /** constructors **/
        ThetaStarBasic2();
        ThetaStarBasic2(std::string name, costmap_2d::Costmap2DROS *costmap_ros);
        ThetaStarBasic2(std::string name, costmap_2d::Costmap2D* costmap, std::string global_frame);
