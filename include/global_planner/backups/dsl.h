...
namespace global_planner {
  ...
  class PathPlanDS : public nav_core::BaseGlobalPlanner {
  public:
    PathPlanDS();
    PathPlanDS(std::string name, costmap_2d::Costmap2D* costmap, std::string global_frame);
    PathPlanDS(std::string name, costmap_2d::Costmap2DROS *costmap_ros);
