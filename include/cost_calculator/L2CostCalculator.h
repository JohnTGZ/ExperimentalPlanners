#ifndef _L2COSTCALCULATOR_H
#define _L2COSTCALCULATOR_H
...
class L2CostCalculator : public CostCalculator {
    public:

        L2CostCalculator(const int nx, const int ny, const int ns, const int neutral_cost): 
